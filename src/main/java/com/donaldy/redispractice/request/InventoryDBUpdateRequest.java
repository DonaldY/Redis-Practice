 ...
 * (2) 更新数据库
 */
public class InventoryDBUpdateRequest implements CacheRequest {
    ...
    public InventoryDBUpdateRequest(ProductInventory productInventory, ProductInventoryService productInventoryService) {
